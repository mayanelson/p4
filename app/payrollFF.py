...
results = client.get(connection_id, limit=100000000, fiscal_year=2022, pay_basis="per Annum", title_description="FIREFIGHTER")
...
db_tools.add_db_data("Firefighters", borose)
