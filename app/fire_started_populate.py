...
sumMode = True
richmond = False
connection_id = "ii3r-svjz" 

query = "cause_fire_description='Child Playing w/Matches/Lighter' OR cause_fire_description='Child Playing w/ Other Open Flame'"
limit = 100000
...
db_tools.add_db_data("Fires_Started", borose)
